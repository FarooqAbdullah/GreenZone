...
<div class="container _content_wrapper">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 padding_0">
				<div class="col-lg-3 col-md-3 cool-sm-12 col-xs-12 padding_0 _left_sidebar_">
					<div class="row">
						<div class="col-sm-12 col-md-12 padding_0">
							<div class="thumbnail padding_0">
								<img src="<?php echo get_template_directory_uri(); ?>/images/post-1.png" alt="Post Image">
								<div class="caption">
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 padding_left_0">
												<div class="date_day">
													<h3>Sun</h3>
													<span>Dec 27</span>
												</div>	
											...
											<div class="col-lg-8 col-md-8 col-sm-8 col-xs-8">
												<h3 class="_thumbnail_title">San Fransisco 49 ers at Detroit Lions</h3>
												<p class="thumnail_description">6:30 pm at the Fillmore Detroit</p>
												<p class="_tickets_availavble">312 tickets available</p>
											</div>
										</div>
									</div>
								</div>
					...
					<div class="row">
						<div class="col-sm-12 col-md-12 padding_0">
							<div class="thumbnail padding_0">
								<img src="<?php echo get_template_directory_uri(); ?>/images/post-2.png" alt="Post Image">
								<div class="caption">
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 padding_left_0">
					...
					<div class="row">
						<div class="col-sm-12 col-md-12 padding_0">
							<div class="thumbnail padding_0">
								<img src="<?php echo get_template_directory_uri(); ?>/images/post-3.png" alt="Post Image">
								<div class="caption">
									<div class="row">
										<div class="col-md-12 col-sm-12">
											<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4 padding_left_0">
				...
				<div class="col-lg-6 col-md-6 cool-sm-12 col-xs-12 _center_content">
					<div>
						<!-- Nav tabs -->
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation"><a href="#just_announced" aria-controls="just_announced" role="tab" data-toggle="tab">Just Announced</a></li>
						</ul>

						<!-- Tab panes -->
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="hot_tickets">
								<div class="_center_tickets_wrapper">
									<h3>Justein Beiber: Purpose World Tour <span class="_program_type">Rock and Pop</span></h3>
								</div>
								<div class="_center_tickets_wrapper">
									<h3>Justein Beiber: Purpose World Tour <span class="_program_type">Rock and Pop</span></h3>
								</div>
							...
							<div role="tabpanel" class="tab-pane" id="just_announced">
								<div class="_center_tickets_wrapper">
									<h3>Justein Beiber: Purpose World Tour <span class="_program_type">Rock and Pop</span></h3>
								</div>
								<div class="_center_tickets_wrapper">
