		...
		<div class="row _ticket_info_checkout">
			<div class="padding_0 col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 _right">
					<div class="row">
						<div class="_thankyou_face">
							<div class="_thankyou_face_wrapper">
								<span class="_left_eye">&nbsp;</span>
								<span class="_right_eye">&nbsp;</span>
								<span class="_smile">)</span>
							</div>
						</div>
						<div class="_thankyou_text">
							Thank you :)
						</div>
					</div>
					<div class="row">
